...
python main_fsvae_denoise.py fashionmnist_weight_tuning -config NetworkConfigs/FASHION.yaml -device 2
python main_fsvae_denoise_large.py cifar10_v1 -config NetworkConfigs/CIFAR10.yaml -test 0 -device 0
python main_fsvae_denoise_large.py -name fashionmnist_e300 -config NetworkConfigs/FASHION.yaml -test 0 -device 0
python main_fsvae_denoise.py -name mnist_largenetwork_2 -config NetworkConfigs/MNIST.yaml -device 0
